      ...
      <div className="flex flex-col md:flex-row mt-0 pr-5 ml-5 md:mr-0 w-full">
        ...
        <div className="w-full md:w-3/10 md:mt-20 md:pl-4 md:ml-10">
          ...
          <div className="mb-4">
            <div className="flex justify-between mb-2">
              ...
              <span>
                $
                {cartItems
                  .reduce((acc, item) => acc + item.quantity * item.precio, 0)
                  .toLocaleString()}
              </span>
            </div>
          ...
          <div className="rounded-lg border border-gray-300 p-5 pt-0">
            <h2 className="text-xl font-bold mt-4 mb-4">Resumen del carrito</h2>
            <ul>
              {cartItems.map((item) => (
                <li key={item.product}>
                  <div className="flex items-center mb-2">
                    ...
                    <div>
                      ...
                      <p>{new Intl.NumberFormat('en-US', { style: 'currency', currency: 'USD', minimumFractionDigits: 0 }).format(item.precio)}</p>
                    </div>
                  </div>
                </li>
              ))}
