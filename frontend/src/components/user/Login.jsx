            ...
            <div className="relative flex flex-col sm:justify-center items-center bg-gray-100 ">
              <div className="relative sm:max-w-sm max-w-2xl w-full">
                ...
                <div className="relative w-full rounded-3xl  px-6 py-4 bg-gray-100 shadow-md mx-auto">
                  <label
                    for=""
                    className="block text-xl text-gray-700 text-center font-semibold"
                  >
                    Ingreso
                  </label>
                  ...
                  onSubmit={handleSubmit}>
                    ...
                    <div className="mt-7">
                    <FontAwesomeIcon icon={faLock} classNameName="text-gray-400" />                      
                      <input
                        id="password"
                        type="Contraseña"
                    ...
                    <div className="mt-7 flex">
                      <label className="flex justify-start items-start">
                        ...
                        <div className="select-none text-sm mt-0.5">Recuérdame</div>
                      </label>
